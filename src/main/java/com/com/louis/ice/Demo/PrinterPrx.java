...
package com.com.louis.ice.Demo;
...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default com.zeroc.IceInternal.OutgoingAsync<String> _iceI_printStringAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "printString", null, sync, null);
